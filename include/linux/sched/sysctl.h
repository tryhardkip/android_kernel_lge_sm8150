...
extern unsigned int sysctl_sched_pelt_fast_decay;
extern unsigned int sysctl_sched_idle_drain_reduction;
extern unsigned int sysctl_sched_proactive_balance_threshold;
